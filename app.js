  ...
  class TestimonialsSlider {
    ...
    init() {
      if (this.testimonials.length > 0) {
        ...
        if (container && this.testimonials[0]) {
          container.style.height = this.testimonials[0].offsetHeight + "px";
        }
    ...
    showSlide(index) {
      ...
      const container = document.querySelector(".testimonials-container");
      if (container && this.testimonials[index]) {
        container.style.height = this.testimonials[index].offsetHeight + "px";
      }
