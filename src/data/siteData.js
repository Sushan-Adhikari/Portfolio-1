...
export const aboutData = {
  ...
  skillsTitle: 'Technical Skills and Interests',
  skills: [
    {
    ...
    },
    {
      ...
      tags: ['FastAPI', 'Flask', 'PostgreSQL', 'REST APIs', 'Data Pipelines'],
    },
    {
...
export const projectData = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        'Contributed to national pension platform (300k+ users) with anti-spoofing liveness detection integration.',
